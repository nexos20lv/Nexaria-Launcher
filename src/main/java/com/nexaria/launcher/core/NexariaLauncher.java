...
public class NexariaLauncher {
    ...
    private static boolean isDevelopmentMode() {
        try {
            ...
            // En mode dev, le path contient "target/classes" et n'est pas un .jar ou la
            // propriété nexaria.dev est "true"
            return Boolean.getBoolean("nexaria.dev") || path.contains("/target/classes")
                    || path.contains("\\target\\classes") || !path.endsWith(".jar");
        } catch (Exception e) {
