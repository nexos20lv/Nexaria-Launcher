...
import com.nexaria.launcher.services.cache.CacheFactory;
 ...
 * Cette classe remplace LauncherApp et NexariaLauncher pour une architecture
 * unifiée.
 * 
 * @since 1.1.0
 */
public class NexariaLauncherMain {
    ...
    private static boolean isDevelopmentMode() {
        try {
            ...
            boolean isDevMode = Boolean.getBoolean("nexaria.dev") ||
